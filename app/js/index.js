...
$.get("/usercheck",{username:document.getElementsByClassName('txt_user')[user-1].value},function(data,status){if(data!="") $(ele).attr("style","border-color:green"); else $(ele).attr("style","border-color:red"); );
